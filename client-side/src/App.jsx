      ...
      <form className="flex items-center flex-col">
        <label className="block mb-6">
          <input
            ...
            className="neumorphic-input w-96 p-4 placeholder-pl-4 text-black bg-gray-200 rounded-lg shadow-lg focus:outline-none focus:ring-gray-300"
          />
        </label>
        <button className="neumorphic-button font-bold w-32 p-4 bg-red-500 text-gray-100 rounded-lg shadow-lg focus:outline-none hover:border-0">
          Download
        </button>
      </form>
    </div>
